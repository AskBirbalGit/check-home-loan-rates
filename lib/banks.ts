...
const DISBURSE_RANK: Record<string, number> = {
  ...
  "Aptus Value Housing Finance": 45,
  "Shriram Housing Finance": 46,
  ...
  "Axis Finance": 63,
  "SK Finance": 64,
  "Vastu Housing Finance": 65,
  "Motilal Oswal Home Finance": 66,
  "Hero Housing Finance": 67,
  "Mahindra Rural Housing Finance": 68,
  "DCB Bank": 69,
  "CSB Bank": 70,
  "Tamilnad Mercantile Bank": 71,
  "Dhanlaxmi Bank": 72,
  "Suryoday Small Finance Bank": 73,
  "ESAF Small Finance Bank": 74,
  "Capital Small Finance Bank": 75,
  "Fincare Small Finance Bank": 76,
  "Unity Small Finance Bank": 77,
  "Shivalik Small Finance Bank": 78,
  "North East Small Finance Bank": 79,
  "Nainital Bank": 80,
  "ICICI Home Finance": 81,
  "Cent Bank Home Finance": 82,
  "Capri Global Housing Finance": 83,
  "Edelweiss Housing Finance": 84,
  "Indostar Home Finance": 85,
  "Hinduja Leyland Finance": 86,
  "Five-Star Business Finance": 87,
  "Muthoot Fincorp": 88,
  "Shubham Housing Finance": 89,
  "Ummeed Housing Finance": 90,
  "Centrum Housing Finance": 91,
  "DMI Housing Finance": 92,
  "Nido Home Finance": 93,
  "Star Housing Finance": 94,
  "SRG Housing Finance": 95,
  "Manappuram Home Finance": 96,
  "Altum Credo Home Finance": 97,
  "Svatantra Micro Housing Finance": 98,
  "Vridhi Home Finance": 99,
  "Easy Home Finance": 100,
  "Roha Housing Finance": 101,
  "Aviom India Housing Finance": 102,
};
...
const ALIASES: Record<string, string[]> = {
  ...
  "ESAF Small Finance Bank": ["esaf", "esaf sfb"],
  "Capital Small Finance Bank": ["capital sfb", "capital small finance"],
  "Unity Small Finance Bank": ["unity", "unity sfb"],
  "Shivalik Small Finance Bank": ["shivalik", "shivalik sfb"],
  "North East Small Finance Bank": ["north east sfb", "nesfb"],
  "Fincare Small Finance Bank": ["fincare", "fincare sfb"],
  ...
  "Shriram Housing Finance": ["shriram housing", "shriram"],
  "Vastu Housing Finance": ["vastu"],
  ...
  "SRG Housing Finance": ["srg"],
  "Manappuram Home Finance": ["manappuram"],
  "Poonawalla Fincorp": ["poonawalla", "magma"],
  "Edelweiss Housing Finance": ["edelweiss"],
  "Capri Global Housing Finance": ["capri", "capri global"],
  "Star Housing Finance": ["star housing", "akme"],
  "Altum Credo Home Finance": ["altum", "altum credo"],
  "Five-Star Business Finance": ["five star", "five-star", "fivestar"],
  ...
  "Hinduja Leyland Finance": ["hinduja leyland", "leyland finance"],
  "Nido Home Finance": ["nido", "edelweiss housing"],
  "DMI Housing Finance": ["dmi", "dmi housing"],
  "Vridhi Home Finance": ["vridhi"],
  "Easy Home Finance": ["easy home"],
  "Roha Housing Finance": ["roha"],
  "Svatantra Micro Housing Finance": ["svatantra"],
  "Muthoot Fincorp": ["muthoot fincorp", "muthoot pappachan"],
  "Shubham Housing Finance": ["shubham"],
  "Ummeed Housing Finance": ["ummeed"],
  "Aviom India Housing Finance": ["aviom"],
  "Mahindra Rural Housing Finance": ["mahindra", "mahindra rural", "mrhfl"],
  "Indostar Home Finance": ["indostar"],
